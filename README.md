# Things — веб-клон Things 3 (GTD)

Полнофункциональный аналог Things 3 для браузера. Задачи хранятся на вашем Google Drive в виде Markdown-файлов; без подключения Google приложение работает локально (данные в браузере).
